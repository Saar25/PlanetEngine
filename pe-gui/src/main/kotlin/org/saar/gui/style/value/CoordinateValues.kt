...
object CoordinateValues {
    ...
    val zero = object : CoordinateValue {
        override fun computeAxisX(parent: UINode, child: UINode) = 0
        override fun computeAxisY(parent: UINode, child: UINode) = 0
    }

    @JvmStatic
    fun pixels(pixels: Int) = object : CoordinateValue {
        override fun computeAxisX(parent: UINode, child: UINode) = pixels

        override fun computeAxisY(parent: UINode, child: UINode) = pixels
    }

    @JvmStatic
    fun percent(percents: Float) = object : CoordinateValue {
        override fun computeAxisX(parent: UINode, child: UINode): Int {
            return (parent.style.width.get() * percents / 100).toInt()
        }

        override fun computeAxisY(parent: UINode, child: UINode): Int {
    ...
    fun add(a: CoordinateValue, b: Int) = object : CoordinateValue {
        override fun computeAxisX(parent: UINode, child: UINode) = a.computeAxisX(parent, child) + b

        override fun computeAxisY(parent: UINode, child: UINode) = a.computeAxisY(parent, child) + b
    }
