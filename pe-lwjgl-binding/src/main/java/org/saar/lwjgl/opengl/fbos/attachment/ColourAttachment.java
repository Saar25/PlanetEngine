...
public class ColourAttachment implements Attachment {
    ...
    public static ColourAttachment withTexture(int index, Texture texture, IFormatType iFormat,
    ...
    public static ColourAttachment withRenderBuffer(int index, RenderBuffer renderBuffer, IFormatType iFormat) {
        return new ColourAttachment(index, new AttachmentRenderBuffer(renderBuffer, iFormat));
    }

    public static ColourAttachment withRenderBuffer(int index, IFormatType iFormat) {
