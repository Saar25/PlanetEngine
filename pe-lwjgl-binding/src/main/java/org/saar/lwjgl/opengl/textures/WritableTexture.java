...
public interface WritableTexture extends ReadOnlyTexture {
    ...
    void allocateStorage(TextureTarget target, int levels, InternalFormat internalFormat, int width, int height);

    void allocateStorageMultisample(TextureTarget target, int levels, InternalFormat internalFormat,
                                    int width, int height, boolean fixedSampleLocations);
