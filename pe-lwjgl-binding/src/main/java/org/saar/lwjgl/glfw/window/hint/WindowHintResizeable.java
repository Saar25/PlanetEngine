...
public class WindowHintResizeable extends WindowHintBoolean implements WindowHint {

    private final boolean value;

    public WindowHintResizeable(boolean value) {
        this.value = value;
    }
    ...
    public WindowHintType getType() {
        return WindowHintType.RESIZABLE;
    }
}
