...
object TrueTypeFontLoader {
    ...
    fun bakeFontBitmap(
        buffer: ReadonlyLwjglBuffer, fontHeight: Float, bitmapWidth: Int,
        ...
        MemoryStack.stackPush().use { stack ->
            ...
            STBTruetype.stbtt_BakeFontBitmap(
                buffer.asByteBuffer(), fontHeight,
            ...
            val characters = sequence {
                for (i in 0 until cdata.limit()) {
                    ...
                    yield(TrueTypeCharacter(start + i, localBox.offset(1, 1), localBox, bakedChar.xadvance()))
                }
            }.toList()
